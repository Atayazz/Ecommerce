        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Skate Shop</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{url('product')}}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top" href="product.blade.php"></i>
                <div data-i18n="Account Settings">Products </div>
              </a>
              
            </li>
            <li class="menu-item">
              <a href="{{url('addproductview')}}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt" href="addproduct.blade.php"></i>
